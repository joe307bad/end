  ...
  return /******/ (() => { // webpackBootstrap
    /******/ 	var __webpack_modules__ = ({
      ...
      /***/ ((module, __unused_webpack_exports, __webpack_require__) => {
        ...
        var Point = __webpack_require__(956);
        var _faceCount = 0;
        var Face = function Face(point1, point2, point3, register) {
          this.id = _faceCount++;
      ...
      /***/ ((module, __unused_webpack_exports, __webpack_require__) => {
        ...
        var Tile = __webpack_require__(936),
          Face = __webpack_require__(857),
          Point = __webpack_require__(956);
        var Hexasphere = function Hexasphere(radius, numDivisions, hexSize) {
          this.radius = radius;
          var tao = 1.61803399;
          var corners = [new Point(1000, tao * 1000, 0), new Point(-1000, tao * 1000, 0), new Point(1000, -tao * 1000, 0), new Point(-1000, -tao * 1000, 0), new Point(0, 1000, tao * 1000), new Point(0, -1000, tao * 1000), new Point(0, 1000, -tao * 1000), new Point(0, -1000, -tao * 1000), new Point(tao * 1000, 0, 1000), new Point(-tao * 1000, 0, 1000), new Point(tao * 1000, 0, -1000), new Point(-tao * 1000, 0, -1000)];
          var points = {};
...
// Set Normal.z to (multiply U.x by V.y) minus (multiply U.y by V.x)
        ...
        var Tile = function Tile(centerPoint, hexSize) {
